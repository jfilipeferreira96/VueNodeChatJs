...
module.exports.login = async (req, res, next) => {
  try {
    ...
    return res.json({ status: true, user: { _id: user._id, username: user.username, email: user.email, avatarImage: user.avatarImage, isAvatarImageSet: user.isAvatarImageSet } });
  } catch (ex) {
    next(ex);
  }
};
